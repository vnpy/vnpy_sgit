...
{
private:
    CThostFtdcTraderApi* api;            //API锟斤拷锟斤拷
    thread task_thread;                    //锟斤拷锟斤拷锟竭筹拷指锟诫（锟斤拷python锟斤拷锟斤拷锟斤拷锟斤拷锟捷ｏ拷
    TaskQueue task_queue;                //锟斤拷锟斤拷锟斤拷锟??
    bool active = false;                //锟斤拷锟斤拷状态
